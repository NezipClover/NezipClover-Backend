		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid" id="mainContent">
					<!-- Page Heading -->
					<div
						class="d-sm-flex flex-column align-items-center justify-content-center my-4 py-4  bg-white">
						<div class="row mb-4">
							<h1 class="h3 mb-0 text-gray-800">
								<div class="sidebar-brand-icon rotate-n-15">
									<i class="fas fa-sad-tear text-primary"></i>
								</div>
								<div class="sidebar-brand-text mx-3 row">WHERE IS MY HOME?</div>
							</h1>
						</div>
						<div class="row">
							<div class="card mb-4">
			...
			<script type="text/javascript">
				...
				function displayPlaces(places) {
					...
					for (var i = 0; i < places.length; i++) {
						...
						// 마커를 생성하고 지도에 표시합니다
						var marker = addMarkerCate(new kakao.maps.LatLng(
				...
				//환경정보 마킹  함수
				var markersP =[]
				function setCenterP(lat, lng, bizCode) {
					// 이동할 위도 경도 위치를 생성합니다
					console.log("setting pollution info //////////////////////////////");
					var moveLatLon = new kakao.maps.LatLng(lat, lng);
					var imageSrc = null // 마커이미지의 주소입니다    
					if(bizCode == 21){
						imageSrc='./img/smoke.png'
					}else if (bizCode == 22){
						imageSrc='./img/waterpollution.jpg'
						
					}else if(bizCode==1000){
						imageSrc='./img/park.png'
					...
					var markerImage = new kakao.maps.MarkerImage(imageSrc,
							imageSize, imageOption); // 마커가 표시될 위치입니다
