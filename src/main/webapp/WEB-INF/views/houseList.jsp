					...
					<div class="row h-100">
						...
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4 h-100">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">전체 조회 목록(클릭시
										지도에 위치 표시)</h6>
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
								...
								<div id="ma" class="card-body"
									...
									<table id="house_list" width="100%" class='table'>
										...
										<c:forEach items='${houses}' var='house'>
											<tr>
												<td><a
													href="${root}/house/searchApt?aptCode=${house.aptCode}&aptName=${house.aptName}&lat=${house.lat}&lng=${house.lng}">${house.aptName}</a></td>
												<td>${house.dongName}</td>
												<td>${house.buildYear}</td>
												<td>${house.jibun}</td>
												<td style="display: none;">${house.lat}</td>
												<td style="display: none;">${house.lng}</td>
											</tr>
										</c:forEach>
									</table>
								</div>
